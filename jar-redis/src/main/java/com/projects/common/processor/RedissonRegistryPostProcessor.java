package com.projects.common.processor;

import cn.hutool.core.collection.CollectionUtil;
import com.projects.common.constants.RedisConstant;
import com.projects.common.facade.RedisFacade;
import com.projects.common.handler.RedisConnectionHandler;
import com.projects.common.properties.RedisProperties;
import lombok.Data;
...
public class RedissonRegistryPostProcessor implements BeanFactoryPostProcessor, EnvironmentAware, DisposableBean {
    ...
    public void setEnvironment(Environment environment) {
        // 绑定redis配置
        redisProperties = Binder.get(environment).bind("edu.redis", Bindable.of(RedisProperties.class)).get();
        // 校验配置参数是否符合规范
