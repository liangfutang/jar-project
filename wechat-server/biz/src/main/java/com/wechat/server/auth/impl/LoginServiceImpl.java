...
import com.edu.common.exception.LoginException;
import com.edu.common.exception.NoAccountException;
...
public class LoginServiceImpl implements LoginService {
    ...
    public UserDTO login(UserApiParam user) {
        ...
        if (!AccountStateEnum.isNormal(existUser.getStates())) {
        ...
        StpUtil.login(existUser.getId(), SaLoginConfig
                .setExtra(Constant.USER_NAME, existUser.getName())
                .setExtra(Constant.PHONE_NO, existUser.getMobile())
